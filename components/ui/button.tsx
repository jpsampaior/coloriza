...
const buttonVariants = cva(
  "inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-slate-950 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 dark:focus-visible:ring-slate-300",
  {
    variants: {
      variant: {
        default:
          "bg-primary text-slate-50 shadow-sm hover:bg-primary/90 dark:bg-primary dark:text-slate-50 dark:hover:bg-primary/90",
        ...
        outlineConstructive:
          "border border-green-500 bg-white shadow-sm hover:bg-green-500/50 dark:border-green-900 dark:bg-green-900 dark:hover:bg-green-900/90 dark:hover:text-slate-50",
        secondary:
